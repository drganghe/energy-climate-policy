...
[GCAM](https://gcims.pnnl.gov/modeling/gcam-global-change-analysis-model), Global Change Assessment Model (GCAM), an integrated assessment tool for exploring consequences and responses to global change.

[C-ROADS](https://www.climateinteractive.org/c-roads/), Climate Rapid Overview and Decision Support

[LEAP](https://leap.sei.org/), The Long-range Energy Alternatives Planning System

[TIMES](https://iea-etsap.org/times-the-integrated-markal-efom-system/l), TIMES is a technology-rich, bottom-up, linear optimization framework. 
...
[MERGE](https://eea.epri.com/models.html#tab=2), Model for Evaluating the Regional and Global Effects of GHG Reduction Policies
...
[EnergyPlus](https://energyplus.net/), EnergyPlus is a whole building energy simulation program that engineers, architects, and researchers use to model energy and water use in buildings.
