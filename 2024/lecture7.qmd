...
![]({{< var file_path >}}/images/2/perez-planetary-energy.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![]({{< var file_path >}}/images/grazing-animals-like-sheep-enjoy-using-the-shadows-of-wind.webp){width=70% fig-align="center"}
:::

::: {.column width="50%"}
![]({{< var file_path >}}/images/solar-farm-benefits.webp){fig-align="center"}
:::
:::
...
![]({{< var file_path >}}/images/3/climate-change-solar-wind-sdm.png){fig-align="center"}
...
![]({{< var file_path >}}/images/US_nuclear_power_plants_map.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![]({{< var file_path >}}/images/small_bwr.jpg){fig-align="center"}
...
::: {.column width="50%"}
![]({{< var file_path >}}/images/small_pwr.jpg){fig-align="center"}
...
![]({{< var file_path >}}/images/nuclear_fuel_cycle.png){fig-align="center"}
...
::: columns
::: {.column width="60%"}
![]({{< var file_path >}}/images/three-island-historical-site.JPG){fig-align="center" width="60%"}
:::
...
::: columns
::: {.column width="60%"}
![]({{< var file_path >}}/images/next-gen-nuclear.png){fig-align="center"}
:::
...
![]({{< var file_path >}}/images/livermore-fusion-breakthrough.jpg){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![]({{< var file_path >}}/images/battery-management-system.png){fig-align="center"}
:::
...
![]({{< var file_path >}}/images/role-of-long-duration-storage.jpg){fig-align="center"}
