...
date-format: long
image: "/lectures/images/8/heat_engine.png"
format:
  revealjs:
    theme: white
...
![](/lectures/images/8/heat_engine.png){fig-align="center"}
...
![](/lectures/images/8/gas-turbine-engine.png){fig-align="center"}
...
![](/lectures/images/8/coal_fired_power_plant_diagram.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](/lectures/images/8/Brayton_cycle.png){fig-align="center"}
...
::: {.column width="50%"}
![](/lectures/images/8/Rankine_cycle.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](/lectures/images/8/georgia_power_plant_scherer.png){fig-align="center"}
:::
...
![](/lectures/images/8/GE-CCGT-diagram.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](/lectures/images/8/fission.png){fig-align="center"}
...
::: {.column width="50%"}
![](/lectures/images/8/fusion-reactions.jpeg){fig-align="center"}
...
![](/lectures/images/8/US_nuclear_power_plants_map.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](/lectures/images/8/small_bwr.jpg){fig-align="center"}
...
::: {.column width="50%"}
![](/lectures/images/8/small_pwr.jpg){fig-align="center"}
...
![](/lectures/images/8/nuclear_fuel_cycle.png){fig-align="center"}
...
::: columns
::: {.column width="60%"}
![](/lectures/images/8/three-island-historical-site.JPG){fig-align="center" width="60%"}
:::
...
::: columns
::: {.column width="60%"}
![](/lectures/images/8/next-gen-nuclear.png){fig-align="center"}
:::
...
![](/lectures/images/8/livermore-fusion-breakthrough.jpg){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](/lectures/images/8/hydro.png){fig-align="center"}
...
::: {.column width="50%"}
![](/lectures/images/8/pumped-storage.jpeg){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](/lectures/images/8/battery-management-system.png){fig-align="center"}
:::
...
![](/lectures/images/8/role-of-long-duration-storage.jpg){fig-align="center"}
...
::: footer
Back to Title [Slide](https://drganghe.github.io/energy-climate-policy/lectures/lecture8.html/#/title-slide), All [Lectures](https://drganghe.github.io/energy-climate-policy/lectures.html), Course [Home](https://drganghe.github.io/energy-climate-policy/), or Learn More About [Gang He](https://drganghe.github.io)
:::
