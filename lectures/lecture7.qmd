...
::: columns
::: {.column width="50%"}
![Heqing Solar Cooker Project in Zhangye](/lectures/images/7/Heqing_Solar_Cooker_photo.webp){fig-align="center"}
:::

::: {.column width="50%"}
![Young NaDEET students in Namibia learning to use a parabolic solar cooker](/lectures/images/7/NaDEET_solar_cooking_training.webp){fig-align="center"}
:::
:::
