...
date-format: long
image: "/lectures/images/7/hybrid-power-systems.png"
format:
  revealjs:
    theme: white
...
![](/lectures/images/7/Solar_spectrum.png){fig-align="center"}
...
<center>
![](/lectures/images/7/silicon-atomic-structure.jpeg){width=50% fig-align="center"}


::: columns
::: {.column width="50%"}
![](/lectures/images/7/Boron-atomic-structure.jpeg){width=80% fig-align="center"}
:::

::: {.column width="50%"}
![](/lectures/images/7/Phosphorus-atomic-structure.jpeg){width=80% fig-align="center"}
:::
:::
</center>
...
::: columns
::: {.column width="30%"}
![](/lectures/images/7/silicon-lattice.png){fig-align="center"}
:::

::: {.column width="30%"}
![](/lectures/images/7/p-type-silicon.png){fig-align="center"}
:::

::: {.column width="30%"}
![](/lectures/images/7/n-type-silicon.png){fig-align="center"}
:::
...
![](/lectures/images/7/p-n-junction.png){fig-align="center"}
...
::: {.column width="50%"}
![](/lectures/images/7/solar-irradiance.png){fig-align="center"}
:::
:::
...
![](/lectures/images/7/best-research-cell-efficiencies.webp){fig-align="center"}
...
![](/lectures/images/7/World_PVOUT_map.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](/lectures/images/7/pm-and-solar.gif){fig-align="center"}
:::

::: {.column width="50%"}
![](/lectures/images/7/global-pm-solar-reduction.jpeg){fig-align="center"}
:::
...
![](/lectures/images/7/prioritizing-solar-deployment.png){fig-align="center"}
...
![](/lectures/images/7/Concentrating-Solar-Thermal-Power-Applications.png){fig-align="center"}
...
![](/lectures/images/7/block-island-wind.jpeg){fig-align="center"}
...
![](/lectures/images/7/upwind-downwind.png){fig-align="center"}

:::

::: {.column width="50%"}
![](/lectures/images/7/blade-efficiency.png){fig-align="center"}
:::
...
![](/lectures/images/7/wind-distribution.png){fig-align="center"}
...
![](/lectures/images/7/wind-power-curve.png){fig-align="center"}
...
![](/lectures/images/7/global-wind-power-density-map.webp){fig-align="center"}
...
::: {.column width="50%"}
![](/lectures/images/7/turbine-hub-height-rotor-capacity.png){fig-align="center"}
:::

::: {.column width="50%"}
![](/lectures/images/7/Turbine-Hub-Height-Chart.png){fig-align="center"}
:::
...
![](/lectures/images/7/US_Wind_Power_Resource_at_100-Meter_Hub_Height.webp){fig-align="center"}
...
::: {.column width="50%"}
![](/lectures/images/7/offshore-floating-turbines.png){fig-align="center"}
:::

::: {.column width="50%"}
![](/lectures/images/7/resources-demand-offshore-us.png){width="70%" fig-align="center"}
:::
...
![](/lectures/images/7/grazing-animals-like-sheep-enjoy-using-the-shadows-of-wind.webp){fig-align="center"}
...
![](/lectures/images/7/hybrid-power-systems.png){fig-align="center"}
