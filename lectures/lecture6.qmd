---
title: "Lecture 6 Energy Conversion Technologies: Solar and Wind"
description-meta: "Solar and windtechnologies"
author: "Gang He"
date: October 16, 2023
date-format: long
image: "/lectures/images/6/hybrid-power-systems.png"
format:
  revealjs:
    theme: white
...
![](/lectures/images/6/Solar_spectrum.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![Heqing Solar Cooker Project in Zhangye](/lectures/images/6/Heqing_Solar_Cooker_photo.webp){fig-align="center"}
:::

::: {.column width="50%"}
![Young NaDEET students in Namibia learning to use a parabolic solar cooker](/lectures/images/6/NaDEET_solar_cooking_training.webp){fig-align="center"}
:::
:::
...
<center>
![](/lectures/images/6/silicon-atomic-structure.jpeg){width=50% fig-align="center"}


::: columns
::: {.column width="50%"}
![](/lectures/images/6/Boron-atomic-structure.jpeg){width=80% fig-align="center"}
:::

::: {.column width="50%"}
![](/lectures/images/6/Phosphorus-atomic-structure.jpeg){width=80% fig-align="center"}
:::
:::
</center>
...
::: columns
::: {.column width="30%"}
![](/lectures/images/6/silicon-lattice.png){fig-align="center"}
:::

::: {.column width="30%"}
![](/lectures/images/6/p-type-silicon.png){fig-align="center"}
:::

::: {.column width="30%"}
![](/lectures/images/6/n-type-silicon.png){fig-align="center"}
:::
...
![](/lectures/images/6/p-n-junction.png){fig-align="center"}
...
::: {.column width="50%"}
![](/lectures/images/6/solar-irradiance.png){fig-align="center"}
:::
:::
...
![](/lectures/images/6/best-research-cell-efficiencies.webp){fig-align="center"}
...
![](/lectures/images/6/World_PVOUT_map.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](/lectures/images/6/pm-and-solar.gif){fig-align="center"}
:::

::: {.column width="50%"}
![](/lectures/images/6/global-pm-solar-reduction.jpeg){fig-align="center"}
:::
...
![](/lectures/images/6/prioritizing-solar-deployment.png){fig-align="center"}
...
![](/lectures/images/6/Concentrating-Solar-Thermal-Power-Applications.png){fig-align="center"}
...
![](/lectures/images/6/block-island-wind.jpeg){fig-align="center"}
...
![](/lectures/images/6/upwind-downwind.png){fig-align="center"}

:::

::: {.column width="50%"}
![](/lectures/images/6/blade-efficiency.png){fig-align="center"}
:::
...
![](/lectures/images/6/wind-distribution.png){fig-align="center"}
...
![](/lectures/images/6/wind-power-curve.png){fig-align="center"}
...
![](/lectures/images/6/global-wind-power-density-map.webp){fig-align="center"}
...
::: {.column width="50%"}
![](/lectures/images/6/turbine-hub-height-rotor-capacity.png){fig-align="center"}
:::

::: {.column width="50%"}
![](/lectures/images/6/Turbine-Hub-Height-Chart.png){fig-align="center"}
:::
...
![](/lectures/images/6/US_Wind_Power_Resource_at_100-Meter_Hub_Height.webp){fig-align="center"}
...
::: {.column width="50%"}
![](/lectures/images/6/offshore-floating-turbines.png){fig-align="center"}
:::

::: {.column width="50%"}
![](/lectures/images/6/resources-demand-offshore-us.png){width="70%" fig-align="center"}
:::
...
![](/lectures/images/6/grazing-animals-like-sheep-enjoy-using-the-shadows-of-wind.webp){fig-align="center"}
...
![](/lectures/images/6/hybrid-power-systems.png){fig-align="center"}
