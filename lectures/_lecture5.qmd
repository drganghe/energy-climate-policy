...
date-format: long
image: "/lectures/images/declining-discounting.jpeg"
format:
  revealjs:
    theme: white
...
![](/lectures/images/lazard-lcoe-2021.png){fig-align="center"}
...
::: {.column width="50%"}
![](/lectures/images/estimated-contributions-to-pv-cost-reduction.webp){fig-align="center"}
:::
