...
Please read the stories about the [Shoreham Nuclear Power Plant](https://en.wikipedia.org/wiki/Shoreham_Nuclear_Power_Plant) and the [Diablo Canyon Power Plant](https://en.wikipedia.org/wiki/Diablo_Canyon_Power_Plant)--two nuclear projects with contrasting outcomes. Shoreham was decommissioned without even operating commercially, leaving Long Island rate-payers to cover its costs, Diablo Canyon was offered to extend operation as part of California's clean energy transition.
...
In 2021, Diablo Canyon Power Plant generated nearly 9% of California's electricity and roughly 15% of the State's clean energy production. The plant has been granted a 5 year extension beyond its scheduled closure in 2025. 
...
- Capacity factor: **80%**   
- Discount rate: **4%**   
- Capital investment cost for extension: **$1.4** billion (forgivable loans, considered the only investment, past investments are sunk costs and should not be considered in this calculation).  
- Assuming the O&M costs are 3% of the investment costs, average fuel costs are [\$5.37/MWh]^[https://www.nei.org/CorporateSite/media/filefolder/resources/reports-and-briefs/2023-Costs-in-Context_r1.pdf]. 
...
Get to understand what composes the 6 billion price tag, and what are the hidden costs? Check the political economy of the energy policy and investment decisions.
